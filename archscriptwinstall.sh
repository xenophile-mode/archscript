...
pacstrap /mnt base base-devel zsh grml-zsh-config grub os-prober intel-ucode efibootmgr dosfstools freetype2 fuse2 mtools iw wpa_supplicant dialog xorg xorg-server xorg-xinit mesa xf86-video-intel

# Generate fstab
genfstab -U /mnt >> /mnt/etc/fstab

# Copy post-install system cinfiguration script to new /root
cp -rfv ~/archscript/archscriptwinstall2.sh /mnt/root
chmod a+x /mnt/root/archscriptwinstall2.sh
#cp ~/archscript/archscriptwinstall2.sh /mnt 
